...
xe template-param-set uuid=$dstUUID \
    name-description="COMMUNITY TEMPLATE for Windows 10 Server (Technical Preview): 32 or 64-bit.  XenTools MUST be installed for full menu effects offered by Metro" \
