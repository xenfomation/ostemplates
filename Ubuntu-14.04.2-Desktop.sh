...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Ubuntu 14.04.2 Desktop")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE: Ubuntu 14.04.2 Desktop from http://www.ubuntu.com/" \
