...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Bella OS 2.2")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE for Bella OS 2.2 from http://www.bellaos.org/download.html" \
