...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Parsix GNU/Linux 7.0")
xe template-param-set uuid=$dstUUID \
    name-description="COMMUNITY TEMPLATE for Parsix GNU/Linux 7.0 from http://www.parsix.org/wiki/Donate" \
