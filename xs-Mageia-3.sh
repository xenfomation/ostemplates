...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Mageia 3")
xe template-param-set uuid=$dstUUID \
    name-description="COMMUNITY TEMPLATE for Mageia 3: 32 or 64-bit.  The installer can be downloaded from " \
