...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Mint Linux (LMDE)")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE: Mint Linux (LMDE) from http://www.linuxmint.com/download_lmde.php" \
