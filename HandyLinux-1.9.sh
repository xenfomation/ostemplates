...
##[ HandyLinux 1.9 ]###########################################################
# 2015, JK Benedict | @xenfomation | xenfomation@outlook.com
###############################################################################

srcUUID=$(xe template-list name-label="Other install media" --minimal)
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="HandyLinux 1.9")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE for HandyLinux 1.9 from http://handylinux.org/" \
