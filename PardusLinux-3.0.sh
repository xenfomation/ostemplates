...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Pardus Linux 3.0")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE: Pardus Linux 3.0 from http://sourceforge.net/projects/gnupardus/files/Pardus3.0/" \
