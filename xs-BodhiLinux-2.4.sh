...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Bodhi Linux 2.4")

xe template-param-set uuid=$dstUUID \
	name-description="COMMUNITY TEMPLATE for Bodhi Linux 2.4 (32 or 64-bit).  The installer media can be downloaded from http://www.bodhilinux.com/" \
