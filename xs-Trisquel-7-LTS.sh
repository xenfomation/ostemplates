...
dstUUID=$(xe vm-clone uuid=$srcUUID new-name-label="Trisquel 7 LTS Desktop")
xe template-param-set uuid=$dstUUID \
    name-description="COMMUNITY TEMPLATE for Trisquel 7 LTS Desktop: 32 or 64-bit.  The LiveCD/Install Media can be downloaded from http://trisquel.info/" \
